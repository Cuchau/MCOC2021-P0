...
#Para trabajar el tipo de dato single o double sacar el # para que funcione esa funcion
...
archivo= open("sist_ec_caso_5_single.txt","w")
#archivo= open("sist_ec_caso_5_double.txt","w")
